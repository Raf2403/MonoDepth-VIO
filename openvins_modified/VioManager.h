...
public:
  ...
  /**
  * @brief Feed function for depth camera measurements
  * @param timestamp Time that this image was collected
  * @param depth_image The depth image (CV_32FC1)
  */
  void feed_measurement_depth(double timestamp, const cv::Mat &depth_image);
...
protected:
  ...
  // Buffer for depth images: timestamp -> image
  std::map<double, cv::Mat> depth_buffer;
